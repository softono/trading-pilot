...
import BackupCodes from "@/modules/admin/account/AccountBackupPage";
...
export default function AdminAccountTfaPage() {
  ...
  return (
    <>
      <AccountBlock activeTab="Two Factor Authentication" basePath="/admin" />
