...
import { getUserMailsList } from "@/server/modules/admin/user/user.service";
...
import { validateUserId } from "@/server/modules/account/account.service";
...
async function handler(
  ...
  const res = await getUserMailsList(
    String(id),
    validated.data,
